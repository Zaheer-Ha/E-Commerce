...
mongoose.connect("mongodb+srv://vikasdeveloper7888:vikas7888@cluster0.ecxujh7.mongodb.net/myshop?retryWrites=true&w=majority",{
...
app.post("/userdata",async(req,res)=>{
    ...
    try{
        await user.save()
        res.status(200).send("Registration Succesfull, Please Login");
    }catch(err){
        console.log(err);
    res.status(200).send('Email Already exits');
    }
