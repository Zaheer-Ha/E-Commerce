                ...
                <div className="container">
                    <div className="header-left">
                        <div className="header-dropdown mr-3 pr-1">
                            <Link to="#" className="pl-0">USD</Link>
                        ...
                        <div className="header-dropdown mr-auto">
                            <Link to="#" className="pl-0"><i className="flag-us flag"></i>ENG</Link>
                            <div className="header-menu">
                                <ul>
                                    <li><Link to="#"><i className="flag-us flag mr-2"></i>ENG</Link>
                                    </li>
                                    <li><Link to="#"><i className="flag-fr flag mr-2"></i>FRA</Link></li>
                                </ul>
                            </div>
                            {/* <!-- End .header-menu --> */}
                        </div>
                    ...
                    <div className="header-left">
                        ...
                        <nav className="main-nav w-100">
                            <ul className="menu">
                                ...
                                <li>
                                    <Link to="demo7-product.html">Support</Link>
                                    {/* <!-- End .megamenu --> */}
                                </li>
                                <li>
